...
public:
	...
	float PlaySequence(UGameplayAbility* AnimatingAbility, FGameplayAbilityActivationInfo ActivationInfo, UPaperZDAnimSequence* Sequence, FName SlotName = "DefaultSlot", float InPlayRate = 1.0f, float StartingPosition = 0.0f, FZDOnAnimationOverrideEndSignature OnOverrideEnd = FZDOnAnimationOverrideEndSignature());
